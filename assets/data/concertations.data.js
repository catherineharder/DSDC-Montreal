...
window.CONC = {
  "famsP": [
    ...
    {
      "key": "gov",
      "label": "Métropolitain et municipal",
      "dot": "gov",
      "boxes": [
        {
          "id": "cmm",
    ...
    {
      "key": "rec1",
      "label": "Instituts, observatoires et chaires",
      "dot": "rec1",
      "boxes": [
        {
          "id": "inspq",
    ...
    {
      "key": "rec2",
      "label": "Universités et centres de recherche",
      "dot": "rec2",
      "boxes": [
        {
          "id": "udem",
  ...
  "defs": [
    {
      "t": "Comité",
      "ac": "",
      "d": "Groupe restreint mandaté par une instance autour d'un objet précis. Permanent, ad hoc ou consultatif; il exécute un travail délimité au service d'une table ou d'une direction."
    },
    {
